...
public class colorfinderblack {
    ...
    public static void main(String[] args) {
    	...
    	//scan(true,10,ColorSensor.Color.BLACK);
    	...
    	//scan(false,8,ColorSensor.Color.BLACK);
    	...
    	while (true) {
            ...
            while (col == ColorSensor.Color.BLACK) {
                ...
                if (col != ColorSensor.Color.BLACK) {
                    scan(true, 1, ColorSensor.Color.BLACK);
                    scan(false, 2, ColorSensor.Color.BLACK);
                }
    		...
    		speaker.playTone(523,200);
                ...
                scan(true,12,ColorSensor.Color.BLACK);
                scan(false,12,ColorSensor.Color.BLACK);
            }
